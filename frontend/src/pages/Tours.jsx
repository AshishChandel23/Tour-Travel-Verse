            ...
            <Container>
                ...
                { error && <h4 className="text-center pt-5">{error}</h4>}
                {
                    ...
                    <Row>
                        {
                            tours?.map(tour=>(
                                <Col className="mb-4" md='6' sm='6' key={tour.id} lg='3'><TourCard tour={tour}/></Col>
                            ))
                        }
                        <Col lg='12'>
                            <div className="pagination d-flex align-items-center justify-content-center gap-4 mt-4">
